...
### Fixed
- Fix crash (`EXC_BREAKPOINT / brk 1`) when clicking a video with an invalid or missing file — guard against `Int64(Double.nan)` trap from indefinite `CMTime` duration in thumbnail and waveform generators
- Add file existence checks before loading waveform and thumbnail strip data
...
[0.1.1]: https://github.com/iamsachin/cloom/releases/tag/v0.1.1
